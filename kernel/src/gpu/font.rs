//! # Bitmap Font
//!
//! Provides a simple 8x16 bitmap font for console rendering.
...
/// Returns a 16-byte array where each byte represents one row of 8 pixels
...
/// Checks if a pixel is set in a glyph
pub fn glyph_pixel(glyph: &[u8; 16], x: u32, y: u32) -> bool {
...
/// 8x16 bitmap font data for ASCII characters 0-127
